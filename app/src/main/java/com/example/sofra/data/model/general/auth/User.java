...
package com.example.sofra.data.model.general.auth;
...
public class User {
    ...
    @Expose
    private GeneralResponse region;
    ...
    public GeneralResponse getRegion() {
        return region;
    }

    public void setRegion(GeneralResponse region) {
        this.region = region;
    }
